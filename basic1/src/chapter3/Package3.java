...
public class Package3 {
	...
	public static void main(String[] args) {
		...
		// Random 클래스 : 난수를 생성하느 클래스
		Random random = new Random();
		System.out.println(random.nextInt());
		// 범위 제약
		System.out.println(random.nextInt(10)); // 10이라는 정수 범위안에서 난수가 발생한다
		...
		now = now.withYear(2025).withDayOfMonth(9);
		System.out.println(now);
		...
		// Date를 String으로 변경
		// SimpleDateFormat 클래스를 사용하여 지정한 포맷의 문자열로 변경 가능
