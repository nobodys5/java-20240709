package com.kyp.springboot.repository;
...
extends JpaRepository<SampleUserEntity, String> {
    ...
    List<SampleUserEntity> findByNameOrderByTelNumberDesc(String address);
    ...
    @Query(value = "SELECT *" + "FROM sample_user" +  "WHERE name = :name" +  "AND address = :address", nativeQuery=true )
