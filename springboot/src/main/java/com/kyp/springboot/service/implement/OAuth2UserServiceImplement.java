...
// - 반드시 DefaultOAuth2UserService 클래스르 확장해야함
public class OAuth2UserServiceImplement extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        String registraion = userRequest.getClientRegistration().getClientName();

        try {
            System.out.println(registraion);                        // 인증서버에서 전달받은 객체들이 담겨있음
            System.out.println("==============================================================");
