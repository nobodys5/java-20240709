package com.kyp.springboot.config;
...
import com.kyp.springboot.filter.JwtAuthenticationFilter;
import com.kyp.springboot.handler.OAuth2SuccessHandler;
import com.kyp.springboot.service.implement.OAuth2UserServiceImplement;
...
class FailedAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        response.getWriter().write("{\"message\": \"인증 및 인가에 실패했씁니다.\"}");
        }
